...
# Reading datasets and giving coloumn names
  ...
  Reads the features .txt file into a table ,give column names to variables ,this file basically contains the various measrements and     are used as coulmn names in the combined data set.
